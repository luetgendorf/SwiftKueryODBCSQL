...
struct ODBCParameterSet {
    ...
    private func parameterData() throws -> ([UnsafeMutablePointer<Int8>?], [Int32], [Int32]) {
        ...
        try self.parameters.forEach {
            if let binaryConvertibleParameter = $0 as? ODBCBinaryParameterConvertible {
                let parameterData = binaryConvertibleParameter.asODBCBinaryParameter()
